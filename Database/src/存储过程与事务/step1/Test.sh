...
#! /bin/bash
# 数据初始化
gsql -d postgres -U gaussdb -W'Passwd123@123' -h localhost  -p5432  < /data/workspace/myshixun/src/step1/fibonacci.sql >log.txt 2>&1
gsql -d postgres -U gaussdb -W'Passwd123@123' -h localhost  -p5432 -c "drop procedure if exists sp_fibonacci;">log.txt 2>&1
#---------- 运行学生代码 ---------- 
gsql -d postgres -U gaussdb -W'Passwd123@123' -h localhost  -p5432 -f  /data/workspace/myshixun/src/step1/test1.sql 
