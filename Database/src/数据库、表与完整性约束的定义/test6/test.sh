...
#---------- 评测前删除hr ---------
gsql -d postgres -U gaussdb -W'Passwd123@123' -p5432 -c "drop table if exists s;" >log.txt 2>&1

#---------- 运行学生代码 ---------- 
gsql -d postgres -U gaussdb -W'Passwd123@123' -p5432 -f /data/workspace/myshixun/src/test6/test6.sql >log.txt 2>&1
